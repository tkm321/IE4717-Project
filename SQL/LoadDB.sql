INSERT INTO products (product_id, product_name, product_price, product_category, product_subcat, product_discount, product_stock) VALUES
    (1, 'APPLE MACBOOK AIR 15"', 1899.00, 1, 'MACBOOK',30,100),
    ...
    (6, 'SONY OLED TV XR-48A90K', 4037.00, 3, 'TV',20,100),
    (7, 'SAMSUNG OLED TV QA65S95BAKXXS', 5449.00, 3, 'TV',0,100),
    (8, 'SONY SOUND BAR HT-A9', 2725.00, 3, 'SOUND SYSTEM',0,100),
    (9, 'APPLE AIRPODS PRO (2ND GENERATION) WITH MAGSAFE CASE (USB-C) MTJV3ZA/A', 362.35, 3, 'HEADPHONES',10,100),
    ...
    (12, 'ECOVACS ROBOTIC VACUUM DEEBOT T20 OMNI', 1299.00, 4, 'VACUUM CLEANER',5,100);
