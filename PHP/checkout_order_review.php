        ...
        foreach ($selectedProductIds as $productId => $selected) {
            ...
            if ($selected && $quantities[$productId] > 0) {
                ...
                if (is_numeric($productId)) {
                    ...
                    // Fetch product details (product_id, product_name, and unit_price) from the database
                    $sql = "SELECT product_id, product_name, product_price FROM products WHERE product_id = $productId";
